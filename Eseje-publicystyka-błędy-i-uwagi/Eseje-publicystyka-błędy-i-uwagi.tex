...
\begin{center}
  ...
  \begin{tabular}{|c|c|c|c|c|}
    ...
    17  & 15 & & nam$^{ 7 }$ & nam \\
    20  & &  1 & $^{ 9 }$\emph{Canadian} & $^{ 8 }$\emph{Canadian} \\
    20  & &  1 & \emph{News30} & \emph{News, 30} \\
    27  & 10 & & \emph{Dona Richardsona} & Dona Richardsona \\
    27  & 11 & & \emph{Joela Richardsona} & Joela Richardsona \\
